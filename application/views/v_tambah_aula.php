	      ...
	      <div class="content">
	        ...
	        <div class="">
	          <div class="formPermohonan">
	            <h2 class="formHeader">Tambah Data Aula</h2>
	            <!-- <?php echo validation_errors(); ?> -->
	            <form class="" method="post" action="<?= base_url('index.php/search/tambah_aula'); ?>">
								...
								<div class="inputWrapper">
									...
									<input  class="form-control" id="tampung" name="tampung">
								</div>
								<div class="inputWrapper">
									<label>Status</label>
