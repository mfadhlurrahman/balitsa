	      ...
	      <div class="content">
	        ...
	        <div class="">
	          <div class="formPermohonan">
	            <h2 class="formHeader">Edit Data Aula</h2>
	            <!-- <?php echo validation_errors(); ?> -->
	            <form class="" method="post" action="<?= base_url('index.php/search/update_aula'); ?>">
	             <?php foreach ($aula as $au) :?>
								<div class="inputWrapper">
									<label>Kode Aula</label>
									<?php echo form_error('kode'); ?>
									<input  class="form-control" id="kode" name="kode" value="<?= $au->kd_aula?>">
								</div>
								<div class="inputWrapper">
									<label>Nama Aula</label>
									<?php echo form_error('nama'); ?>
									<input  class="form-control" id="nama" name="nama" value="<?= $au->nm_aula?>">
								</div>
								<div class="inputWrapper">
									<label>Daya Tampung</label>
									<?php echo form_error('blok'); ?>
									<input  class="form-control" id="tampung" name="tampung" value="<?= $au->daya_tampung?>">
								</div>
								<div class="inputWrapper">
									<label>Status</label>
									<?php echo form_error('no'); ?>
									<input  class="form-control" id="status" name="status" value="<?= $au->status?>">
								</div>
	              <div class="inputWrapper">
