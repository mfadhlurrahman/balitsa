	...
	<div class="content">
		<div class="topNav">
			<div style="float: left;width: 500px;">
					<h1>Pencarian Data Permohonan</h1>					
				</div>
		...
		<?php echo form_open('Laporanpdf/Cetak');?>
		...
		<br><br>
			...
			<a class="aBtn red" href="<?php echo base_url('index.php/search/tampil_permohonan') ?>">Back</a>
			<input class="btnSubmit" type="submit" value="Cetak Berdasarkan Tanggal Mulai atau Selesai"></input>
			<?php echo form_close(); ?>
		</div>
	</div>
</div>
