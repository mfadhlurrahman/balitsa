	      ...
	      <div class="content">
	        ...
	        <div class="">
	          <div class="formPermohonan">
	            ...
	            <form class="" method="post" action="<?= base_url('index.php/search/tambah_peneliti'); ?>">
								...
								<div class="inputWrapper">
									...
									<input  class="form-control" id="terakhir" name="terakhir">
								</div>
								<div class="inputWrapper">
								...
								<div class="inputWrapper">
									...
									<input  class="form-control" id="fakultas" name="fakultas">
								</div>
								<div class="inputWrapper">
									<label>Jurusan</label>
