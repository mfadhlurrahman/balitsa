	      ...
	      <div class="content">
	        ...
	        <div class="">
	          <div class="formPermohonan">
	            <h2 class="formHeader">Edit Data User</h2>
	            <?php echo validation_errors(); ?>
	            <form class="" method="post" action="<?= base_url('index.php/search/update_user'); ?>">
	             <?php foreach ($user as $usr) :?>
								<div class="inputWrapper">
									<label>NIP</label>
									<input  class="form-control" id="nip" name="nip" value="<?= $usr->nip?>">
								</div>
								<div class="inputWrapper">
									<label>Username</label>
									<input  class="form-control" id="username" name="username" value="<?= $usr->username?>">
								</div>
								<div class="inputWrapper">
									<label>Password</label>
									<input  class="form-control" id="pass" name="pass" value="<?= $usr->password?>">
								</div>
								<div class="inputWrapper">
									<label>Otoritas</label>
									<select class="form-control" id="otoritas" name="otoritas" >
											<option value="<?= $usr->otoritas?>" disable><?= $usr->otoritas?></option>
